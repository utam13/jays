        ...
        <div class="row">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <button type="submit" class="btn btn-primary btn-sm pull-right" data-toggle="modal" data-target="#form_bidangpekerjaan" onclick="ambil_bidang('<?= base_url(); ?>bidangpekerjaan/proses/1','','','','','','<?= date('dmYHis'); ?>-gambar_slide','')">Tambah</button>

                            <form class="form-horizontal" method="POST" action="<?= base_url(); ?>bidangpekerjaan">
                                <div class="form-group">
                                    <div class="col-sm-4">
                                        <div class="input-group margin">
                                            <div class="input-group-btn">
                                                <a href="<?= base_url(); ?>bidangpekerjaan" class="btn btn-danger btn-sm">Segarkan</a>
                                            </div>
                                            <input type="text" class="form-control input-sm" id="cari" name="cari" value="" placeholder="Isi nama bidang" required>
                                            <div class="input-group-btn">
                        ...
                        <div class="col-sm-12 table-responsive">
                            <table class="table table-bordered table-striped" id="mytable">
                                <thead>
                                    <tr>
                                        <th width="10px">No</th>
                                        <th width="150px">Nama Bidang</th>
                                        <th width="200px">Kalimat Slide</th>
                                ...
                                <tbody>
                                    <?
                                    $hasil = json_decode($bidangpekerjaan);
                                    foreach ($hasil as $bp) {
                                    ?>
                                        <tr>

                                            <td align="center" style="font-size:9pt;"><?= $no; ?></td>
                                            <td style="font-size:9pt;"><?= $bp->nama_bidang; ?><br><br><i class="fa <?= $bp->font_icon; ?>"></i> <?= $bp->font_icon; ?></td>
                                            <td style="font-size:9pt;"><?= $bp->kalimat_slide; ?></td>
                                            <td style="font-size:9pt;"><?= $bp->kalimat_singkat; ?></td>
                                            <td align="center">
                                                <a href="<?= base_url(); ?>pekerjaan/index/1/<?= $bp->kdbidkerja; ?>" class="btn btn-success btn-xs"><?= number_format($bp->jmlpekerjaan, 0, ',', ','); ?> Pekerjaan</a>
                                                <br><br>
                                                <a href="<?= base_url() . "upload/" . $bp->gambar_slide; ?>" target="_blank" class="btn btn-default btn-xs"><i class="fa fa-image"></i></a>
                                                <a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#form_bidangpekerjaan" onclick="ambil_bidang('<?= base_url(); ?>bidangpekerjaan/proses/2','<?= $bp->kdbidkerja; ?>','<?= $bp->nama_bidang; ?>','<?= $bp->kalimat_slide; ?>','<?= $bp->kalimat_singkat; ?>','<?= $bp->font_icon; ?>','<?= $bp->gambar_slide; ?>','<?= $bp->gambar_slide; ?>')"><i class="fa fa-pencil"></i></a>
                                                <a href="<?= base_url(); ?>bidangpekerjaan/proses/3/<?= $bp->kdbidkerja; ?>" class="btn btn-danger btn-xs" onclick="return confirm('Menghapus bidang pekerjaan <?= $bp->nama_bidang; ?> ?')"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <? $no++;
                                    } ?>
...
<!-- Modal -->
<!--Formulir-->
<div class="modal fade" id="form_bidangpekerjaan" tabindex="-1" role="dialog" aria-labelledby="form_bidangpekerjaan" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="form_bidangpekerjaan_label">Formulir Bidang Pekerjaan</h4>
            </div>
            <form id="frm_bidangpekerjaan" name="frm_bidangpekerjaan" method="post" action="">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label>Nama Bidang (max. 80 karakter)</label>
                        <input type="text" class="form-control" name="nama_bidang" id="nama_bidang" value="" maxlength=80 autocomplete="off" required />
                    </div>
                    <div class="form-group">
                        <label>Kalimat Slide (max. 80 karakter)</label>
                        <input type="text" class="form-control" name="kalimat_slide" id="kalimat_slide" value="" maxlength=80 autocomplete="off" required />
                    </div>
                    <div class="form-group">
                        <label>Uraian Singkat (max. 150 karakter)</label>
                        <input type="text" class="form-control" name="kalimat_singkat" id="kalimat_singkat" value="" maxlength=150 autocomplete="off" required />
                    </div>
                    <div class="form-group">
                        <label>Font Icon</label>
                        <select class="form-control" id="font_icon" name="font_icon" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" id="pilih_slide" name="pilih_slide" accept=".jpg,.png,.gif" style="display:none;">
                        <input type="hidden" id="lokasi" name="lokasi" value="<?= base_url(); ?>">
                        <div class="input-group margin">
                            <div class="input-group-btn">
                                <button type="button" class="btn btn-danger" onclick="upload_slide()">Pilih (Ukuran 1920x930 pixel, max. 2Mb)</button>
                            </div>
                            <input type="text" class="form-control" id="file_target" name="file_target" value="" placeholder="Pilih Gambar Slide ukuran 1920 x 930 pixel, max. 2 Mb" readonly required>
                            <div id="btnlihat" class="input-group-btn">
                                <a href="#" id="linkslide" target="_blank" class="btn btn-success">Lihat</a>
                            </div>
                        </div>
                    </div>
                </div>
